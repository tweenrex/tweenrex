!function(){"use strict"
function t(t,e){t.push.apply(t,e)}function e(t,e){for(var i=0;i<e.length;i++){var n=t.indexOf(e[i]);-1!==n&&t.splice(n,1)}}function i(t){return Array.isArray(t)?t:[t]}function n(n){var s,r,a=!1!==(n=n||{}).distinct,o=n.onNext||c,u=n.onDispose||c,h=n.onSubscribe||c,l=n.onUnsubscribe||c,p=i(n.subscribe||[])
...
if(t=r[e],!a||t!==s){s=t
for(var n=0;n<i.length;n++)i[n](t)}}r.length=0,o(t,p)}},subscribe:function(n){return n=i(n),h(p),t(p,n),function(){e(p,n),l(p)}}}}function s(t,e){return t instanceof e?t:Object.create(e.prototype)}function r(t){return"string"==typeof t}function a(t,e,i){return f(b(e,t),i)}function o(t){var e=s(this,o)
...
i._last=t,i.seek(s)}
var r=n(e)
return i.dispose=function(){i.pause(),i._pos=0,i._time=0,i.playbackRate=1,i._tweens=_,i.labels={},r.dispose()},i.next=r.next,i.value=r.value,i.subscribe=r.subscribe,i}var c=function(){},_=void 0,h="undefined"!=typeof requestAnimationFrame?requestAnimationFrame.bind(window):function(t){return setTimeout(function(){return t(Date.now())},1e3/60)},l=n({onSubscribe:function(t){t.length||h(l.next)},onNext:function(t,e){e.length&&h(l.next)}}),p=Math,f=p.min,b=p.max
...
for(var a=this._tweens,o=function(t,e){return t===_?e:t}(r((s=s||{}).position)?this.labels[s.position]:s.position,this.duration),c=s.sequence,h=s.stagger,l=n.length,p=Array(l),f=0;l>f;f++){var b=function(t){return t instanceof u?t:u(t)}(n[f])
b.isPlaying&&b.pause(),b._timer=_,p[f]={pos:o,tween:b},c&&(o+=b.duration),h&&(o+=h)}return t(a,p),function(){e(a,p)}},play:function(){var t=this._timer
...
return t&&(t(),this._sub=this._last=_,this._opts.onPause&&this._opts.onPause()),this},reverse:function(){return this.playbackRate*=-1,this},seek:function(t){var e,i=this.playbackRate>=0,n=this.duration,s=r(t)?this.labels[t]:t
i&&s>=n?(s=n,this.pause(),e=!0):i||s>0||(s=0,this.pause(),e=!0),this._time=s
var o=s/(n||1)
this.easing&&(o=this.easing(o)),e&&this._opts.onFinish&&this._opts.onFinish()
var u=this._tweens
if(this.next(o),u)for(var c=0,h=u.length;h>c;c++){var l=u[c],p=l.tween,f=l.pos,b=a((s-f)/(f+(p.duration||1)-f),0,1)
p.next(b)}return this},getLabel:function(t){return this.labels[t]},setLabel:function(t,e){return this.labels[t]=e,this}}
var g=window
