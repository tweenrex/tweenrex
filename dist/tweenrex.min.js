...
var h=this._tweens
if(this.next(u),h)for(var c=0,l=h.length;l>c;c++){var p=h[c],f=p.tween,b=p.pos,g=a((o-b)/(b+(f.duration||1)-b),0,1)
f.next(g)}return this},getLabel:function(t){return this.labels[t]},setLabel:function(t,e){return this.labels[t]=e,this}}
var g=window
