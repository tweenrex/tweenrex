...
const math$2 = Math;
const abs = math$2.abs;
const cos = math$2.cos;
const sin = math$2.sin;
const sqrt$1 = math$2.sqrt;
const pow = math$2.pow;
const ceil = math$2.ceil;
const floor$1 = math$2.floor;
...
const circ = recurve(n => -1 * (sqrt$1(1 - pow(n, 2)) - 1));
...
function steps(count, mode) {
    const fn = mode === 'end' ? floor$1 : ceil;
    return (x) => {
